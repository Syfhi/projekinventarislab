...
<header class="header-top">
    ...
    <div class="d-flex align-items-center gap-3">
        <div class="search-wrapper">
            ...
            <input type="text" class="form-control shadow-none" placeholder="Cari peminjaman...">
        </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="fw-semibold">Laptop Lenovo ThinkPad</div>
                                </td>
                                <td>25 Apr 2026</td>
                                <td>30 Apr 2026</td>
                                <td>
                                    <span class="badge bg-warning-subtle text-warning badge-status text-uppercase" style="font-size: 0.65rem;">
                                        Dipinjam
                                    </span>
                                </td>
                                <td class="text-end px-4">
                                    <button class="btn btn-light btn-sm"><i class="bi bi-eye"></i></button>
                                    <button class="btn btn-light btn-sm text-success"><i class="bi bi-check-circle"></i></button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="px-4">
                                    <div class="fw-bold">Dosen Andi</div>
                                    <div class="text-muted small">Dosen</div>
                                </td>
                                <td>
                                    <div class="fw-semibold">Proyektor Epson</div>
                                </td>
                                <td>20 Apr 2026</td>
                                <td>27 Apr 2026</td>
                                <td>
                                    <span class="badge bg-success-subtle text-success badge-status text-uppercase" style="font-size: 0.65rem;">
                                        Dikembalikan
                                    </span>
                                </td>
                                <td class="text-end px-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="fw-semibold">Kamera DSLR Canon</div>
                                </td>
                                <td>15 Apr 2026</td>
                                <td>20 Apr 2026</td>
                                <td>
                                    <span class="badge bg-danger-subtle text-danger badge-status text-uppercase" style="font-size: 0.65rem;">
                                        Terlambat
                                    </span>
                                </td>
                                <td class="text-end px-4">
                                    <button class="btn btn-light btn-sm"><i class="bi bi-eye"></i></button>
                                    <button class="btn btn-light btn-sm text-danger"><i class="bi bi-exclamation-circle"></i></button>
                                </td>
                            </tr>
